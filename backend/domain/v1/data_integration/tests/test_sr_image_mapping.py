...
def test_map_preserves_placement_bboxes() -> None:
    rid = "00000000-0000-0000-0000-000000000099"
    bboxes = [[0.0, 1.0, 100.0, 200.0], [10.0, 20.0, 30.0, 40.0]]
    by_page = {
        1: [
            {
                "path": "/tmp/a.png",
                ...
                "size_bytes": 100,
                "image_index": 0,
                "placement_bboxes": bboxes,
            }
        ],
    }
    rows = map_extracted_images_to_sr_report_rows(rid, by_page)
    assert len(rows) == 1
    assert rows[0]["placement_bboxes"] == bboxes
