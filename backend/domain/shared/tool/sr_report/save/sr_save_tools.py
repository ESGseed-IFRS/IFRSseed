...
def save_sr_report_body(
    ...
    Args:
        ...
        subtitle: 페이지 부제목 (선택, 한글 보고서 상단 부제 라인)
    ...
    try:
        ...
        row_meta: Dict[str, Any] = {"toc_path": toc_path, "subtitle": subtitle}
        enrich_bodies_with_toc_subtitle_embeddings([row_meta])
        body_id = uuid.uuid4()
        entity = SrReportBody(
            id=body_id,
            report_id=_to_uuid(report_id),
            ...
            toc_path=toc_path,
            subtitle=subtitle,
            content_embedding=row_meta.get("content_embedding"),
            content_embedding_text=row_meta.get("content_embedding_text"),
            embedding_id=None,
            embedding_status=row_meta.get("embedding_status") or "pending",
        )
        session.add(entity)
        session.commit()
...
def save_sr_report_body_batch(
    ...
    Args:
        ...
        bodies: 본문 행 리스트. 각 항목은 page_number, content_text 필수,
                is_index_page, content_type, paragraphs, toc_path, subtitle,
                content_embedding(1024 float 리스트), content_embedding_text, embedding_status 선택.
        ...
        for idx, item in enumerate(bodies):
            try:
                ...
                entity = SrReportBody(
                    ...
                    content_embedding_text=item.get("content_embedding_text"),
    ...
    *,
    ...
    Args:
        ...
        rows: 각 항목 page_number 필수;
              ...
              image_type, caption_text, caption_confidence, extracted_data,
              placement_bboxes, image_embedding, image_embedding_text, embedding_status 선택.
        ...
        for idx, item in enumerate(rows):
            try:
                ...
                entity = SrReportImage(
                    ...
                    placement_bboxes=item.get("placement_bboxes"),
                    image_embedding=item.get("image_embedding"),
                    image_embedding_text=item.get("image_embedding_text"),
...
def save_sr_report_image(
    ...
    placement_bboxes: Optional[List[Any]] = None,
) -> str:
    """
    ...
    Args:
        ...
        caption_text: 캡션 (선택)
        placement_bboxes: 페이지 내 배치 [[x0,y0,x1,y1], ...] (선택)
    ...
    try:
        ...
        entity = SrReportImage(
            ...
            placement_bboxes=placement_bboxes,
            extracted_data=None,
