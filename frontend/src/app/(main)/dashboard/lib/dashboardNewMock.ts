...
export type ApprovalDomain = 'ghg' | 'sr' | 'audit';
...
> = {
  'outbox.progress': { ghg: 1, sr: 2, audit: 0 },
  'outbox.completed': { ghg: 8, sr: 6, audit: 1 },
  'outbox.rejected': { ghg: 1, sr: 1, audit: 0 },
  'outbox.draft': { ghg: 1, sr: 1, audit: 0 },
  'inbox.request': { ghg: 2, sr: 1, audit: 1 },
  'inbox.history': { ghg: 3, sr: 3, audit: 1 },
  'inbox.cc': { ghg: 1, sr: 1, audit: 0 },
};
...
export const APPROVAL_COUNTS_HOLDING: Record<
  ...
  Record<ApprovalDomain, number>
> = {
  'outbox.progress': { ghg: 3, sr: 2, audit: 1 },
  'outbox.completed': { ghg: 24, sr: 18, audit: 2 },
  'outbox.rejected': { ghg: 2, sr: 2, audit: 0 },
  'outbox.draft': { ghg: 2, sr: 1, audit: 0 },
  'inbox.request': { ghg: 5, sr: 6, audit: 2 },
  'inbox.history': { ghg: 7, sr: 8, audit: 2 },
  'inbox.cc': { ghg: 4, sr: 5, audit: 1 },
};
