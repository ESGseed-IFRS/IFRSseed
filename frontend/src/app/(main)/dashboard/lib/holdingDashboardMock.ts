...
export const HOLDING_RECENT_ACTIVITIES: {
  ...
  { date: '03.25 11:08', type: '반려', actor: '연시은 차장', target: '시큐아이 · GRI 405-1', color: 'red' },
  { date: '03.24 17:41', type: '리마인드', actor: '박지훈 팀장', target: '오픈핸즈 전체 미제출', color: 'amber' },
  { date: '03.24 09:15', type: '승인', actor: '김지속 팀장', target: '엠로 · GHG Scope1', color: 'green' },
  { date: '03.23 15:00', type: '반려', actor: '연시은 차장', target: '멀티캠 · TCFD S-1', color: 'red' },
];
