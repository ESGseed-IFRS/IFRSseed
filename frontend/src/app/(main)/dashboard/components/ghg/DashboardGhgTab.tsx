...
import { getSubsidiaryOverviewGhg } from '@/app/(main)/dashboard/lib/dashboardNewMock';
import { HoldingGhgDashboardPanel } from '@/app/(main)/dashboard/components/holding/HoldingGhgDashboardPanel';
...
export function DashboardGhgTab({ mode }: { mode: 'subsidiary' | 'holding' }) {
  ...
  if (mode === 'holding') {
    return <HoldingGhgDashboardPanel />;
  }
