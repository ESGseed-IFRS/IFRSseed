...
import { getApprovalInboxBadgeCount } from '@/app/(main)/dashboard/lib/approvalUnified';
import type { ApprovalDomain, ApprovalMenuKey } from '@/app/(main)/dashboard/lib/dashboardNewMock';

export function DashboardNewShell({ mode }: { mode: DashboardPerspective }) {
  ...
  const approvalActionCount = useMemo(() => getApprovalInboxBadgeCount(), []);
