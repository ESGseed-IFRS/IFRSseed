...
export const DP_CARDS_INIT: SrDpCard[] = [
  ...
  {
    id: 'd2-scope1-integrated',
    title: 'Scope 1 총 온실가스 배출량 통합 공시',
    standards: [
      { code: 'ESRSE1-E1-6-44-a', type: 'ESRS', label: 'ESRSE1-E1-6-44-a' },
      { code: 'GRI305-1-a', type: 'GRI', label: 'GRI305-1-a' },
      { code: 'IFRS2-29-a-i-1', type: 'IFRS', label: 'IFRS2-29-a-i-1' },
    ],
    category: '환경',
    deadline: '25.04.11',
    status: 'todo',
  ...
  {
    id: 'd2-scope2-integrated',
    title: 'Scope 2 온실가스 배출량 통합 공시',
    standards: [
      { code: 'ESRSE1-E1-6-44-b', type: 'ESRS', label: 'ESRSE1-E1-6-44-b' },
      { code: 'GRI305-2-a', type: 'GRI', label: 'GRI305-2-a' },
      { code: 'IFRS2-29-a-i-2', type: 'IFRS', label: 'IFRS2-29-a-i-2' },
    ],
    category: '환경',
    deadline: '25.04.11',
    status: 'todo',
  ...
  {
    id: 'd2-ghg-methodology-integrated',
    title: '온실가스 및 가치사슬 산정 방법론 통합 공시',
    standards: [
      { code: 'ESRS2-BP-2-10-b', type: 'ESRS', label: 'ESRS2-BP-2-10-b' },
      { code: 'IFRS2-29-a-iii-1', type: 'IFRS', label: 'IFRS2-29-a-iii-1' },
      { code: 'GRI305-3-g', type: 'GRI', label: 'GRI305-3-g' },
    ],
    category: '환경',
    deadline: '25.04.12',
    status: 'todo',
  ...
  {
    id: 'd2-scope3-categories-integrated',
    title: 'Scope 3 배출 범주 및 활동 내역 통합 공시',
    standards: [
      { code: 'ESRSE1-E1-6-51', type: 'ESRS', label: 'ESRSE1-E1-6-51' },
      { code: 'GRI305-3-d', type: 'GRI', label: 'GRI305-3-d' },
      { code: 'IFRS2-29-a-vi-1', type: 'IFRS', label: 'IFRS2-29-a-vi-1' },
    ],
    category: '환경',
    deadline: '25.04.12',
    status: 'todo',
  ...
  {
    id: 'd2-scope3-total-integrated',
    title: 'Scope 3 온실가스 총 배출량 통합 공시',
    standards: [
      { code: 'ESRSE1-E1-6-44-c', type: 'ESRS', label: 'ESRSE1-E1-6-44-c' },
      { code: 'GRI305-3-a', type: 'GRI', label: 'GRI305-3-a' },
      { code: 'IFRS2-29-a-i-3', type: 'IFRS', label: 'IFRS2-29-a-i-3' },
    ],
    category: '환경',
    deadline: '25.04.12',
    status: 'todo',
  ...
  {
    id: 'd2-mdr-a-actions',
    title: '주요 조치 목록·예상 성과·정책 기여',
    standards: [{ code: 'ESRS2-MDR-A-68-a', type: 'ESRS', label: 'ESRS2-MDR-A-68-a' }],
    category: '환경',
    deadline: '25.04.13',
    status: 'todo',
    assignee: '김가영',
