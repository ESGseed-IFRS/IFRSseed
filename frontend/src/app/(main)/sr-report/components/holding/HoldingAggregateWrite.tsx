...
export function HoldingAggregateWrite({ onInsertToReport }: HoldingAggregateWriteProps) {
  const [selectedDpId, setSelectedDpId] = useState<string>(DP_MASTER_LIST[0]?.dp_id ?? '');
