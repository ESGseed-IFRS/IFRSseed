...
export function IFSyncModal({ tabLabel: _tabLabel, onClose }: Props) {
          ...
          {syncDone && (
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-emerald-600 text-xs">총 49건 데이터가 갱신되었습니다. ({selectedYear}년 {selectedMonth}월)</div>
              </div>
            </div>
          )}
