...
import { Sidebar, type CalcSubTab, type AuditSubTab } from "./Sidebar";
...
const breadcrumbMap: Record<string, string[]> = {
  ...
  'audit-unified': ["3-2. Audit Trail", "통합 감사 추적 (타임라인)"],
  'audit-approval': ["3-2. Audit Trail", "결재함"],
...
export function GHGCalcLayout({
  ...
  const key = mainTab === 'calc' ? `calc-${calcSubTab}` : mainTab === 'audit' ? `audit-${auditSubTab}` : 'report';
