          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 pl-3 border-l border-gray-200">
              ...
              <div className="text-xs">
                <div className="text-gray-800" style={{ fontWeight: 600 }}>{session.userDisplayName}</div>
                <div className="text-gray-400" style={{ fontSize: "10px" }}>{session.corpDisplayName}</div>
              </div>
