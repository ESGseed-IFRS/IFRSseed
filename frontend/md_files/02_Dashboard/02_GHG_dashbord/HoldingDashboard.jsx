      ...
      <Card style={{ padding: "16px 18px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(5, minmax(0,1fr))", gap: 0 }}>
          {[
            ...
            { date:"03.25 11:08", type:"반려",    actor:"연시은 차장", target:"㈜ B화학 · GRI 405-1",   color: P.red   },
            { date:"03.24 17:41", type:"리마인드",actor:"박지훈 팀장", target:"㈜ E바이오 전체 미제출",  color: P.amber },
            { date:"03.24 09:15", type:"승인",    actor:"김지속 팀장", target:"㈜ F반도체 · GHG Scope1",color: P.green },
            { date:"03.23 15:00", type:"반려",    actor:"연시은 차장", target:"㈜ D물산 · TCFD S-1",    color: P.red   },
          ].map((h, i) => (
